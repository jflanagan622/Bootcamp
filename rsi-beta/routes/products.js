...
exports.createProduct = function(req, res) {
	...
	pool.connect(function(err, client, done) {
		...
		if(req.body.product_name) {
			...
			var queryText = 'INSERT INTO products (id, product_name, unit_price, cost) VALUES ($1, $2, $3, $4) RETURNING id'
			client.query(queryText, [uuid.v4(), req.body.product_name, req.body.unit_price, req.body.cost ], function(err, result) {
				done();
